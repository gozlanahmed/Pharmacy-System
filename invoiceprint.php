				...
				<tr class="top">
					<td colspan="6">
						<table>
							<tr> 
								<td class="title">
									<img src="assets/uploadImage/logo/favicon.png" style="width: 100%; max-width: 100px" />
								</td>
...
<?php } ?>
				...
				<tr class="details">
					<td colspan="3"><?php if($row['paymentType']==4){echo " BOK";} if($row['paymentType']==5){echo "Google Pay";} if($row['paymentType']==3){echo "Credit Card";} if($row['paymentType']==2){echo "Cash";} if($row['paymentType']==1){echo "Cheque";}?></td>
